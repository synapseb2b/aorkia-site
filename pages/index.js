  ...
  return (
    <>
      ...
      <main className="bg-black text-white">
        ...
        <section id="valor-imediato" className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <section id="problemas-criticos" className="py-16 md:py-24 bg-gray-50 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-600">Dados sensíveis espalhados sem visibilidade</p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <i className="ri-close-circle-line text-orange-500 text-xl mt-1"></i>
                ...
                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-semibold text-blue-800">DSPM</span>
                  </div>
        ...
        <section id="solucoes-especializadas" className="py-16 md:py-24 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
