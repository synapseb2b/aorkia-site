...
const products = [
  ...
  },
  {
    ...
    description: 'Sua resiliência cibernética está completa? Microsoft, Google e Salesforce não blindam totalmente seus dados contra exclusões, erros ou ransomware. A proteção nativa é um mito de falsa segurança: tem retenção limitada e a responsabilidade final é sempre sua. A AORKIA ativa Keepit — líder global em backup SaaS — para proteção inabalável e estratégica. Garantimos backup 100% imutável com Air Gap, restauração granular e instantânea para seu ecossistema SaaS, e conformidade automatizada com LGPD, GDPR e DORA. Ative resiliência e ROI máximos com a confiança de mais de 15.000 empresas.',
  ...
  },
  {
    ...
    description: 'Sua governança de dados sensíveis está ativa? Dados confidenciais em múltiplas nuvens expõem sua empresa a riscos: vazamentos, multas (LGPD, GDPR) e reputação. O mito da segurança perimetral cria falsa segurança, não revelando dados críticos vulneráveis. A AORKIA transforma incerteza em controle [Query], ativando Plataformas DSPM para governança inquestionável. Descobrimos e classificamos dados automaticamente (incluindo "shadow data"), priorizamos riscos (acesso, uso), e garantimos correção automatizada e conformidade contínua (LGPD, GDPR, HIPAA). Assuma o controle e converta conformidade em vantagem estratégica',
