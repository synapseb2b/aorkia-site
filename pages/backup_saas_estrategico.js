  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section id="risco-real" data-section="risco-real" className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start max-w-6xl mx-auto">
              {/* Ferramentas Nativas */}
              <div className="lg:w-1/2 p-8 rounded-lg border-2 border-red-500 bg-transparent">
                <h3 className="text-2xl font-semibold text-red-600 mb-6 text-center">Ferramentas Nativas (Microsoft 365 / Google)</h3>
                <ul className="space-y-6 text-gray-700 text-lg">
                  <li className="flex items-start">
                    <span className="text-red-500 text-2xl mr-3">❌</span>
                    <div className="text-center">
                      <strong className="block">Retenção Limitada:</strong> Apenas 30-90 dias de histórico, insuficiente para recuperação de longo prazo.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 text-2xl mr-3">❌</span>
                    <div className="text-center">
                      <strong className="block">Sem Proteção contra Ransomware:</strong> Dados podem ser corrompidos ou criptografados por ataques.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 text-2xl mr-3">❌</span>
                    <div className="text-center">
                      <strong className="block">Recuperação Complexa:</strong> Processo manual, demorado e sem garantias de integridade.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 text-2xl mr-3">❌</span>
                    <div className="text-center">
                      <strong className="block">Responsabilidade do Cliente:</strong> Fornecedores deixam claro que a proteção dos dados é sua responsabilidade.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="lg:w-1/2 p-8 rounded-lg border-2 border-green-500 bg-transparent">
                <h3 className="text-2xl font-semibold text-green-600 mb-6 text-center">Backup SaaS com Keepit</h3>
                <ul className="space-y-6 text-gray-700 text-lg">
                  <li className="flex items-start">
                    <span className="text-green-500 text-2xl mr-3">✅</span>
                    <div className="text-center">
                      <strong className="block">Backup Imutável:</strong> Dados protegidos em nuvem independente, impossível de corromper ou apagar.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 text-2xl mr-3">✅</span>
                    <div className="text-center">
                      <strong className="block">Recuperação Granular:</strong> Restaure qualquer item em minutos, de um e-mail a uma conta completa.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 text-2xl mr-3">✅</span>
                    <div className="text-center">
                      <strong className="block">Conformidade Garantida:</strong> Atende LGPD, GDPR e outras regulamentações com trilhas de auditoria.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 text-2xl mr-3">✅</span>
                    <div className="text-center">
                      <strong className="block">Suporte Especializado:</strong> Equipe AORKIA para implementação e gestão contínua.
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section id="responsabilidade" data-section="responsabilidade" className="py-16 md:py-24 bg-white">
        ...
        <section id="resiliencia" data-section="resiliencia" className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              Não é só um Backup. É a Resiliência que salva o seu negócio.
            </h2>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-lg md:text-xl font-semibold text-gray-800">
                O resultado é a garantia de recuperação instantânea e a tranquilidade da conformidade total para o seu negócio.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="pilares" data-section="pilares" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              Os Pilares da Proteção Real
            </h2>
        ...
        {/* Cobertura Completa */}
        <section id="cobertura" data-section="cobertura" className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              Cobertura Completa do seu Ecossistema SaaS
            </h2>
            
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 max-w-4xl mx-auto items-center">
              <div className="flex flex-col items-center">
                <Image src="/icon/microsoft.png" alt="Microsoft 365" width={60} height={60} className="mb-2" />
                <span className="text-sm font-medium text-gray-700 text-center">Microsoft 365</span>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/google.png" alt="Google Workspace" width={60} height={60} className="mb-2" />
              ...
              <div className="flex flex-col items-center">
                <Image src="/icon/dynamics.png" alt="Dynamics 365" width={60} height={60} className="mb-2" />
                <span className="text-sm font-medium text-gray-700 text-center">Dynamics 365</span>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/azure_ad.png" alt="Azure AD" width={60} height={60} className="mb-2" />
                <span className="text-sm font-medium text-gray-700 text-center">Azure AD</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="desafios" data-section="desafios" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              Uma Solução. Respostas para Cada Desafio Estratégico.
            </h2>
        ...
        <section id="confianca" data-section="confianca" className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              Confiança Validada pelo Mercado Global
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 max-w-5xl mx-auto items-center">
              ...
              <div className="flex flex-col items-center">
                <Image src="/icon/oxford.png" alt="Oxford University" width={80} height={60} className="mb-2 grayscale hover:grayscale-0 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/hdi.png" alt="HDI" width={80} height={60} className="mb-2 grayscale hover:grayscale-0 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/bmw.png" alt="BMW" width={80} height={60} className="mb-2 grayscale hover:grayscale-0 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/siemens.png" alt="Siemens" width={80} height={60} className="mb-2 grayscale hover:grayscale-0 transition-all duration-300" />
              </div>
              <div className="flex flex-col items-center">
                <Image src="/icon/volkswagen.png" alt="Volkswagen" width={80} height={60} className="mb-2 grayscale hover:grayscale-0 transition-all duration-300" />
              </div>
            </div>
        ...
        {/* Depoimentos */}
        <section id="depoimentos" data-section="depoimentos" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
        ...
        <section id="certificacoes" data-section="certificacoes" className="py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="relative bg-gradient-to-br from-green-600 to-green-800 rounded-2xl p-8 md:p-12 shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                  <div className="flex flex-col items-center">
                    <Image src="/icon/iso_27001.png" alt="ISO 27001" width={60} height={60} className="mb-2 filter brightness-0 invert" />
                    <span className="text-white text-sm font-medium">ISO 27001</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <Image src="/icon/isae_3402.png" alt="ISAE 3402" width={60} height={60} className="mb-2 filter brightness-0 invert" />
        ...
        <section id="gartner" data-section="gartner" className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-800 mb-12">
              O que o Mercado Diz: Análise do Gartner Peer Insights
            </h2>
