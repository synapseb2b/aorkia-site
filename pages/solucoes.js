  ...
  const solutions = [
    {
      ...
      // Corrigido de .svg para .png conforme seus arquivos
  ...
  return (
    <>
      ...
      <main className="bg-black text-white">
        {/* NAVBAR corrigida com logomarca */}
        <nav className="w-full px-8 py-4 flex items-center justify-between bg-black border-b border-gray-800">
        ...
        {/* FOOTER corrigido com logomarca */}
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-4 mb-6 md:mb-0">
              <Image
                ...
                priority
              />
              <span className="text-gray-400 text-lg">© {new Date().getFullYear()} AORKIA</span>
            </div>
            <div className="flex gap-6">
              <Link href="/" className="text-gray-400 hover:text-primary">Home</Link>
              <Link href="/solucoes" className="text-gray-400 hover:text-primary">Soluções</Link>
              <Link href="/sobre" className="text-gray-400 hover:text-primary">Sobre</Link>
              <Link href="/contato" className="text-gray-400 hover:text-primary">Contato</Link>
            </div>
          </div>
        </footer>
      </main>
